...
export const zh = {
  ...
  'confirm.closeBody': '关闭此文件前，要如何处理当前修改？',
...
export const en: Record<FileManagerLocaleKey, string> = {
  ...
  'explorer.show': 'Show Workspace',
  'explorer.hide': 'Hide Workspace',
  ...
  'confirm.closeBody': 'What should happen to the current changes before this file closes?',
